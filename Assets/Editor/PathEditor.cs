...
public class PathEditor : Editor
{
    ...
    void Input()
    {
        ...
        if (guiEvent.type == EventType.MouseDown && guiEvent.button == 0 && guiEvent.shift) //Cliquer sur le bouton gauche de la sourie tout en appuyant sur Shift
        {
        ...
        {
            float minDstAnchor = creator.anchorDiameter*.5f;
